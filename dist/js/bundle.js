...
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "images/download.svg");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   GoalList: () => (/* binding */ GoalList)
/* harmony export */ });
/* harmony import */ var _core_Component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../core/Component */ "./src/core/Component.ts");
/* harmony import */ var _components_GoalListItem__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/GoalListItem */ "./src/components/GoalListItem.ts");
...
class GoalList extends _core_Component__WEBPACK_IMPORTED_MODULE_0__.BaseComponent {
    ...
    setEvent() {
        this.$target.addEventListener("change", (e) => {
            ...
            const targetGoal = target.closest("[data-goal-id]");
            const targetIdea = target.closest("[data-idea-id]");
    ...
    mounted() {
        ...
        for (let i = 0; i < $goals.length; i++) {
            ...
            new _components_GoalListItem__WEBPACK_IMPORTED_MODULE_1__.GoalListItem($goals[i], Object.assign(Object.assign({}, goal), { title: this.finalGoal.ideas[i].name || "" }));
        }
    }
    get finalGoal() {
...
/***/ "./src/components/GoalListItem.ts":
/*!****************************************!*\
  !*** ./src/components/GoalListItem.ts ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   GoalListItem: () => (/* binding */ GoalListItem)
/* harmony export */ });
/* harmony import */ var _core_Component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../core/Component */ "./src/core/Component.ts");
/* harmony import */ var _utils_constants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/constants */ "./src/utils/constants.ts");


class GoalListItem extends _core_Component__WEBPACK_IMPORTED_MODULE_0__.BaseComponent {
    constructor($target, props) {
        super($target, props);
    }
    template() {
    ...
    getTextareaPlaceholder(idea) {
        const { id, type } = this.props;
        if (type === "final") {
            if (idea.type === "main") {
                return _utils_constants__WEBPACK_IMPORTED_MODULE_1__.FINAL_GOAL_PLACEHOLDER;
            }
            else {
                return `${_utils_constants__WEBPACK_IMPORTED_MODULE_1__.SUB_GOAL_PLACEHOLDER} ${idea.id + 1} `;
            }
        }
        else {
            if (idea.type === "main") {
                return `${_utils_constants__WEBPACK_IMPORTED_MODULE_1__.SUB_GOAL_PLACEHOLDER} ${id + 1} `;
            }
            else {
                return "";
            }
    ...
    getTextareaValue(idea) {
        ...
        return (_a = idea.name) !== null && _a !== void 0 ? _a : "";
    }
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   CENTRAL_INDEX: () => (/* binding */ CENTRAL_INDEX),
/* harmony export */   FINAL_GOAL_PLACEHOLDER: () => (/* binding */ FINAL_GOAL_PLACEHOLDER),
/* harmony export */   SUB_GOAL_PLACEHOLDER: () => (/* binding */ SUB_GOAL_PLACEHOLDER)
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   MY_USER_ID: () => (/* binding */ MY_USER_ID)
/* harmony export */ });
...
/* harmony import */ var _components_GoalList__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/GoalList */ "./src/components/GoalList.ts");
/* harmony import */ var _images_download_svg__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./images/download.svg */ "./src/images/download.svg");
var __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
...
const MY_USER_ID = "2ZERQRUJZ4fUoI7Gm9LX00aMWub2";
const HEADER_TITLE = "MANDAL_ART";
const HEADER_DESCRIPTION = "꿈과 목표를 시각화하여 실현에 이르게 하는 첫 걸음, </br>당신만의 맞춤형 만다라트 계획표로 일상에 변화를 주세요.";
class App extends _core_Component__WEBPACK_IMPORTED_MODULE_1__.BaseComponent {
    constructor() {
        super(...arguments);
          ...
          <ul class="aside-list">
            <li>
              <button class="image-download-button">
                <img src="${_images_download_svg__WEBPACK_IMPORTED_MODULE_3__["default"]}" width="24" height="24" />
              </button>
            </li>
          </ul>
        </aside>
    ...
    setEvent() {
        const imageDownloadButton = document.querySelector(".image-download-button");
    ...
    mounted() {
        return __awaiter(this, void 0, void 0, function* () {
            const goalSection = this.$target.querySelector('.goal-section');
            new _components_GoalList__WEBPACK_IMPORTED_MODULE_2__.GoalList(goalSection, { goals: [] });
        });
    }
    handleImageDownloadButtonClick() {
        html2canvas__WEBPACK_IMPORTED_MODULE_0___default()(this.$body, { foreignObjectRendering: true }).then(canvas => {
